...
alfa_dict_blocks = {
    ...
    2: {x: 50, y: 170, width: 160, height: 90, position: "Директор по /n стратегическому /n планированию", is_manager: true, font: "14px"},
    3: {x: 70, y: 275, width: 140, height: 40, position: "Экспериментальный /n участок", font: "12px"},
    4: {x: 70, y: 330, width: 140, height: 55, position: "Отдел /n финансового /n планирования", font: "12px"},
    5: {x: 70, y: 400, width: 140, height: 40, position: "Служба /n маркетинга", font: "12px"},

    6: {x: 230, y: 170, width: 160, height: 90, position: "Директор по /n персоналу", is_manager: true, font: "14px"},
    7: {x: 250, y: 275, width: 140, height: 40, position: "Отдел кадров", font: "12px"},
    8: {x: 250, y: 330, width: 140, height: 40, position: "Табельное бюро", font: "12px"},
    9: {x: 250, y: 385, width: 140, height: 40, position: "Отдел обучения", font: "12px"},
    10: {x: 250, y: 440, width: 140, height: 40, position: "Бытовой отдел", font: "12px"},

    11: {x: 510, y: 170, width: 500, height: 70, position: "Исполнительный директор /n ", is_manager: true, font: "16px"},

    12: {x: 410, y: 300, width: 160, height: 90, position: "Заместитель /n директора /n по производству", is_manager: true, font: "14px"},
    13: {x: 430, y: 405, width: 140, height: 40, position: "Производственный /n цех 1", font: "12px"},
    14: {x: 430, y: 460, width: 140, height: 40, position: "Производственный /n цех 2", font: "12px"},
    15: {x: 430, y: 515, width: 140, height: 40, position: "Производственный /n цех 3", font: "12px"},
    16: {x: 430, y: 570, width: 140, height: 40, position: "Производственный /n цех 4", font: "12px"},
    17: {x: 430, y: 625, width: 140, height: 40, position: "Автотранспортный /n цех", font: "12px"},
    18: {x: 430, y: 680, width: 140, height: 40, position: "Служба снабжения", font: "12px"},

    19: {x: 590, y: 300, width: 160, height: 90, position: "Главный инженер", is_manager: true, font: "14px"},
    20: {x: 610, y: 405, width: 140, height: 40, position: "ОГЭ", font: "12px"},
    21: {x: 610, y: 460, width: 140, height: 40, position: "ОГМ", font: "12px"},
    22: {x: 610, y: 515, width: 140, height: 40, position: "АСУ", font: "12px"},
    23: {x: 610, y: 570, width: 140, height: 40, position: "Инструментальное /n производство", font: "12px"},
    24: {x: 610, y: 625, width: 140, height: 40, position: "ОКС", font: "12px"},

    25: {x: 770, y: 300, width: 160, height: 90, position: "Коммерческий /n директор", is_manager: true, font: "14px"},
    26: {x: 790, y: 405, width: 140, height: 40, position: "Отдел сбыта", font: "12px"},
    27: {x: 790, y: 460, width: 140, height: 40, position: "Складское хозяйство", font: "12px"},
    28: {x: 790, y: 515, width: 140, height: 40, position: "Финансовый отдел", font: "12px"},
    29: {x: 790, y: 570, width: 140, height: 40, position: "Собственный /n транспорт", font: "12px"},
    30: {x: 790, y: 625, width: 140, height: 55, position: "Производственно -/n коммерческая /n фирма", font: "12px"},

    31: {x: 950, y: 300, width: 160, height: 90, position: "Главный экономист", is_manager: true, font: "14px"},
    32: {x: 970, y: 405, width: 140, height: 40, position: "ПЭО", font: "12px"},
    33: {x: 970, y: 460, width: 140, height: 40, position: "ОТиЗ", font: "12px"},

    34: {x: 1010, y: 535, width: 160, height: 90, position: "Главный бухгалтер", is_manager: true, font: "14px"},
    35: {x: 1030, y: 640, width: 140, height: 40, position: "Бухгалтерия", font: "12px"},

    36: {x: 1200, y: 170, width: 160, height: 90, position: "Начальник ОТК", is_manager: true, font: "14px"},
...
//export lines;
//export arrows;
//export const alfa_dict_blocks = helpers.alfa_dict_blocks
//export const lines = helpers.lines
//export const arrows = helpers.arrows